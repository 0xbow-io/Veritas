...
impl FoldedType {
    pub fn arithmetic_type(dimensions: ArithmeticType) -> FoldedType {
        FoldedType {
            arithmetic: Option::Some(dimensions),
            template: Option::None,
        }
    }
    pub fn template(name: &str) -> FoldedType {
        FoldedType {
            template: Option::Some(name.to_string()),
            arithmetic: Option::None,
        }
    }
    ...
    match statement {
        ...
        Substitution {
            ...
            let access_information_result =
                treat_access(access, meta, program_library, analysis_information);
    ...
    match expression {
        ...
        InlineSwitchOp {
            ...
            let if_false_response =
                type_expression(if_false, program_library, analysis_information);
